/*
	Ejemplo de un menú interactivo en OpenGL con la librería FreeGLUT
*/
...
/*Función de selección de objetos*/
...
/*Función de movimiento de la luz con el mouse*/
...
/*Funciónde movimiento de la luz*/
void motion(int x, int y){
  spin = (spin + (x - begin)) % 360;
  begin = x;
  glutPostRedisplay();
}
/*Función para inicializar los componentes (Luz)*/
